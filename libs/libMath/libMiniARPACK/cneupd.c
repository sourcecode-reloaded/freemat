/* ../SRC/cneupd.f -- translated by f2c (version 20061008).
	...
	bmat_len, ftnlen which_len)
{
    ...
    extern /* Subroutine */ int clahqr_(logical *, logical *, integer *, 
	    ...
	    integer *, complex *, integer *, integer *), claset_(char *, 
	    integer *, integer *, complex *, complex *, complex *, integer *, 
	    ftnlen), ctrsen_(char *, char *, logical *, integer *, complex *, 
	    integer *, complex *, integer *, complex *, integer *, real *, 
	    real *, complex *, integer *, integer *, ftnlen, ftnlen), ctrevc_(
	    char *, char *, logical *, integer *, complex *, integer *, 
	    complex *, integer *, complex *, integer *, integer *, integer *, 
	    complex *, real *, integer *, ftnlen, ftnlen), csscal_(integer *, 
...
/*        %-------------------------------------------% */
	...
	if (s_cmp(which, "LM", (ftnlen)2, (ftnlen)2) == 0 || s_cmp(which, 
	    ...
	    i__1 = ritz;
	    r__1 = workl[i__1].r;
	    r__2 = r_imag(&workl[ritz]);
	    thres = slapy2_(&r__1, &r__2);
...
/*        %---------------------------------------------------------% */
	...
	for (j = 0; j <= i__1; ++j) {
		...
		i__2 = irz + j;
		r__1 = workl[i__2].r;
		r__2 = r_imag(&workl[irz + j]);
		if (slapy2_(&r__1, &r__2) >= thres) {
/* Computing MAX */
		    i__2 = irz + j - 1;
		    r__3 = workl[i__2].r;
		    r__4 = r_imag(&workl[irz + j - 1]);
		    r__1 = eps23, r__2 = slapy2_(&r__3, &r__4);
		    rtemp = dmax(r__1,r__2);
		    i__2 = ibd + j;
		    r__1 = workl[i__2].r;
		    r__2 = r_imag(&workl[ibd + j]);
