/* ../SRC/cnaupd.f -- translated by f2c (version 20061008).
...
/*          Must be 1,2,3,4; See under \Description of cnaupd for the */
...
/* \SCCS Information: @(#) */
/* FILE: naupd.F   SID: 2.4   DATE OF SID: 8/27/96   RELEASE: 2 */
