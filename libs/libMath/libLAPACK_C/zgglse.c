/* ../../../dependencies/lapack/src/zgglse.f -- translated by f2c (version 20061008).
	...
	doublecomplex *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */ int zgemv_(char *, integer *, integer *, 
	    ...
	    integer *, ftnlen, ftnlen, ftnlen), ztrsv_(char *, char *, char *,
...
/*     Solve T12*x2 = d for x2 */
    ...
    ztrsv_("Upper", "No transpose", "Non unit", p, &b[(*n - *p + 1) * b_dim1 
...
/*     Compute the residual vector: */
	...
	i__1 = *n - *m;
	z__1.r = -1., z__1.i = -0.;
	zgemv_("No transpose", &nr, &i__1, &z__1, &a[*n - *p + 1 + (*m + 1) * 
		a_dim1], lda, &d__[nr + 1], &c__1, &c_b1, &c__[*n - *p + 1], &
		c__1, (ftnlen)12);
    } else {
	nr = *p;
    }
