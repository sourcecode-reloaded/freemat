/* ../../../dependencies/lapack/src/sgegs.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int sgegs_(char *jobvsl, char *jobvsr, integer *n, real *a, 
	...
	*beta, real *vsl, integer *ldvsl, real *vsr, integer *ldvsr, real *
	work, integer *lwork, integer *info, ftnlen jobvsl_len, ftnlen 
	jobvsr_len)
{
    ...
    extern /* Subroutine */ int sggbak_(char *, char *, integer *, integer *, 
	    ...
	    , ftnlen, ftnlen), sggbal_(char *, integer *, real *, integer *, 
    ...
    extern /* Subroutine */ int sgghrd_(char *, char *, integer *, integer *, 
	    ...
	    , real *, integer *, integer *, ftnlen, ftnlen), xerbla_(char *, 
	    integer *, ftnlen);
