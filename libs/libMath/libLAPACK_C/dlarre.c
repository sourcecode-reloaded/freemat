/* ../../../dependencies/lapack/src/dlarre.f -- translated by f2c (version 20061008).
	 ...
	 integer *info)
{
    ...
    static doublereal s, gl;
    static integer in;
    static doublereal gu;
    static integer cnt;
    static doublereal eps, tau, nrm, tmp1, offd;
    static integer iend, jblk;
    static doublereal delta, sigma;
