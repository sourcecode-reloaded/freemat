/* ../../../dependencies/lapack/src/dgelss.f -- translated by f2c (version 20061008).
...
/*        Matrix all zero. Return zero solution. */
	...
	i__1 = max(*m,*n);
	dlaset_("F", &i__1, nrhs, &c_b74, &c_b74, &b[b_offset], ldb, (ftnlen)
		1);
	dlaset_("F", &minmn, &c__1, &c_b74, &c_b74, &s[1], &c__1, (ftnlen)1);
	*rank = 0;
	goto L70;
    }
...
/* Computing MIN */
		    ...
		    dgemm_("T", "N", m, &bl, m, &c_b108, &work[il], &ldwork, &
			    b[i__ * b_dim1 + 1], ldb, &c_b74, &work[iwork], n,
			     (ftnlen)1, (ftnlen)1);
		    dlacpy_("G", m, &bl, &work[iwork], n, &b[i__ * b_dim1 + 1]
			    , ldb, (ftnlen)1);
/* L40: */
		}
	    } else {
