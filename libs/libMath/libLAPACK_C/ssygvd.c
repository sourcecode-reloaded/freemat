/* ../../../dependencies/lapack/src/ssygvd.f -- translated by f2c (version 20061008).
...
/*           backtransform eigenvectors: x = inv(L)'*y or inv(U)*y */
		...
		*(unsigned char *)trans = 'T';
	    ...
	    strsm_("Left", uplo, trans, "Non-unit", n, &neig, &c_b11, &b[
...
/*           backtransform eigenvectors: x = L*y or U'*y */
		...
		*(unsigned char *)trans = 'N';
	    ...
	    strmm_("Left", uplo, trans, "Non-unit", n, &neig, &c_b11, &b[
		    b_offset], ldb, &a[a_offset], lda, (ftnlen)4, (ftnlen)1, (
		    ftnlen)1, (ftnlen)8);
	}
    }
