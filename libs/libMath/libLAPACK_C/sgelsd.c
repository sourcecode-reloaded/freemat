/* ../../../dependencies/lapack/src/sgelsd.f -- translated by f2c (version 20061008).
...
/*        Matrix all zero. Return zero solution. */
	...
	i__1 = max(*m,*n);
	slaset_("F", &i__1, nrhs, &c_b82, &c_b82, &b[b_offset], ldb, (ftnlen)
		1);
	slaset_("F", &minmn, &c__1, &c_b82, &c_b82, &s[1], &c__1, (ftnlen)1);
	*rank = 0;
	goto L10;
    }
...
/*     If M < N make sure certain entries of B are zero. */
    ...
    if (*m < *n) {
	i__1 = *n - *m;
	slaset_("F", &i__1, nrhs, &c_b82, &c_b82, &b[*m + 1 + b_dim1], ldb, (
		ftnlen)1);
    }
...
/*           Zero out below R. */
		...
		i__1 = *n - 1;
		i__2 = *n - 1;
		slaset_("L", &i__1, &i__2, &c_b82, &c_b82, &a[a_dim1 + 2], 
			lda, (ftnlen)1);
	    }
	}
...
/*        Zero out below first M rows of B. */
	    ...
	    i__1 = *n - *m;
	    slaset_("F", &i__1, nrhs, &c_b82, &c_b82, &b[*m + 1 + b_dim1], 
		    ldb, (ftnlen)1);
	    nwork = itau + *m;
