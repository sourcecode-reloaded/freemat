/* ../../../dependencies/lapack/src/sgglse.f -- translated by f2c (version 20061008).
	...
	real *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */ int sgemv_(char *, integer *, integer *, real *, 
	    ...
	    *, integer *, ftnlen, ftnlen, ftnlen), strsv_(char *, char *, 
...
/*     Solve T12*x2 = d for x2 */
    ...
    strsv_("Upper", "No transpose", "Non unit", p, &b[(*n - *p + 1) * b_dim1 
	    + 1], ldb, &d__[1], &c__1, (ftnlen)5, (ftnlen)12, (ftnlen)8);

/*     Update c1 */

    i__1 = *n - *p;
    sgemv_("No transpose", &i__1, p, &c_b29, &a[(*n - *p + 1) * a_dim1 + 1], 
...
/*     Compute the residual vector: */
	...
	nr = *m + *p - *n;
	i__1 = *n - *m;
	sgemv_("No transpose", &nr, &i__1, &c_b29, &a[*n - *p + 1 + (*m + 1) *
