/* ../../../dependencies/lapack/src/ztgsyl.f -- translated by f2c (version 20061008).
...
/*     Determine  optimal block sizes MB and NB */
	...
	i__1 = *n;
	for (j = 1; j <= i__1; ++j) {
	    zcopy_(m, &c_b16, &c__0, &c__[j * c_dim1 + 1], &c__1);
	    zcopy_(m, &c_b16, &c__0, &f[j * f_dim1 + 1], &c__1);
/* L10: */
	}
...
/*                 Substitute R(I,J) and L(I,J) into remaining equation. */
		    ...
		    if (i__ > 1) {
			i__3 = is - 1;
			zgemm_("N", "N", &i__3, &nb, &mb, &c_b53, &a[is * 
				a_dim1 + 1], lda, &c__[is + js * c_dim1], ldc,
				 &c_b54, &c__[js * c_dim1 + 1], ldc, (ftnlen)
				1, (ftnlen)1);
			i__3 = is - 1;
			zgemm_("N", "N", &i__3, &nb, &mb, &c_b53, &d__[is * 
		    ...
		    if (j < q) {
			i__3 = *n - je;
			zgemm_("N", "N", &mb, &i__3, &nb, &c_b54, &f[is + js *
