/* ../../../dependencies/lapack/src/zgelss.f -- translated by f2c (version 20061008).
...
/*        Matrix all zero. Return zero solution. */
	...
	dlaset_("F", &minmn, &c__1, &c_b78, &c_b78, &s[1], &minmn, (ftnlen)1);
	*rank = 0;
	goto L70;
    }
...
/* Computing MIN */
		    ...
		    zgemm_("C", "N", m, &bl, m, &c_b2, &work[il], &ldwork, &b[
			    ...
			    ftnlen)1, (ftnlen)1);
		    zlacpy_("G", m, &bl, &work[iwork], n, &b[i__ * b_dim1 + 1]
			    , ldb, (ftnlen)1);
/* L40: */
		}
	    } else {
