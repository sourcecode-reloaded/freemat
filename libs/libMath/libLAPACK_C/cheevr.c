/* ../../../dependencies/lapack/src/cheevr.f -- translated by f2c (version 20061008).
	...
	jobz_len, ftnlen range_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int cstegr_(char *, char *, integer *, real *, 
	    ...
	    integer *, integer *, integer *, ftnlen, ftnlen), cstein_(integer 
...
/*     then call SSTERF or CSTEGR and CUNMTR. */
	...
	if (! wantz) {
	    ...
	    cstegr_(jobz, "A", n, &rwork[indrdd], &rwork[indree], vl, vu, il, 
		    ...
		    rwork[indrwk], lwork, &iwork[1], liwork, info, (ftnlen)1, 
		    (ftnlen)1);
