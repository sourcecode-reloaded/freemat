/* ../../../dependencies/lapack/src/dggevx.f -- translated by f2c (version 20061008).
...
/*     (Workspace: need N, prefer N*NB) */
    ...
    if (ilvl) {
	dlaset_("Full", n, n, &c_b47, &c_b48, &vl[vl_offset], ldvl, (ftnlen)4)
		;
	i__1 = irows - 1;
	i__2 = irows - 1;
    ...
    if (ilvr) {
	dlaset_("Full", n, n, &c_b47, &c_b48, &vr[vr_offset], ldvr, (ftnlen)4)
		;
    }
