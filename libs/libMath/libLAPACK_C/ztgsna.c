/* ../../../dependencies/lapack/src/ztgsna.f -- translated by f2c (version 20061008).
...
/*     Decode and test the input parameters */
    ...
    *info = 0;
    ...
    if (lsame_(job, "V", (ftnlen)1, (ftnlen)1) || lsame_(job, "B", (ftnlen)1, 
	    (ftnlen)1)) {
/* Computing MAX */
	i__1 = 1, i__2 = (*n << 1) * *n;
	lwmin = max(i__1,i__2);
...
/*           (k,k)th pair to the (1,1) position. */
	    ...
	    zlacpy_("Full", n, n, &a[a_offset], lda, &work[1], n, (ftnlen)4);
