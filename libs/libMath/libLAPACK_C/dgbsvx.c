/* ../../../dependencies/lapack/src/dgbsvx.f -- translated by f2c (version 20061008).
...
/* Computing MAX */
			d__2 = anorm, d__3 = (d__1 = ab[i__ + j * ab_dim1], 
				abs(d__1));
			anorm = max(d__2,d__3);
/* L80: */
		    }
...
/* Computing MAX */
		...
		rpvgrw = dlantb_("M", "U", "N", info, &i__1, &afb[max(i__4,
			i__5) + afb_dim1], ldafb, &work[1], (ftnlen)1, (
			ftnlen)1, (ftnlen)1);
		if (rpvgrw == 0.) {
		    rpvgrw = 1.;
		} else {
