/* ../../../dependencies/lapack/src/sggevx.f -- translated by f2c (version 20061008).
...
/*       computed assuming ILO = 1 and IHI = N, the worst case.) */
	...
	maxwrk = *n * 5 + *n * ilaenv_(&c__1, "SGEQRF", " ", n, &c__1, n, &
...
/*     (Workspace: need N, prefer N*NB) */
    ...
    if (ilvl) {
	slaset_("Full", n, n, &c_b47, &c_b48, &vl[vl_offset], ldvl, (ftnlen)4)
		;
	i__1 = irows - 1;
	i__2 = irows - 1;
    ...
    if (ilvr) {
	slaset_("Full", n, n, &c_b47, &c_b48, &vr[vr_offset], ldvr, (ftnlen)4)
		;
    }
