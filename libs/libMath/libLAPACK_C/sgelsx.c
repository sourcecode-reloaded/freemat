/* ../../../dependencies/lapack/src/sgelsx.f -- translated by f2c (version 20061008).
	...
	integer *rank, real *work, integer *info)
{
    ...
    extern /* Subroutine */ int slascl_(char *, integer *, integer *, real *, 
	    ...
	    ftnlen), sgeqpf_(integer *, integer *, real *, integer *, integer 
    ...
    extern /* Subroutine */ int slatzm_(char *, integer *, integer *, real *, 
	    integer *, real *, real *, real *, integer *, real *, ftnlen), 
