/* ../../../dependencies/lapack/src/ztgsen.f -- translated by f2c (version 20061008).
...
/*     eigenvalues of reordered pair (A, B) */
	...
	if (dscale > safmin) {
	    ...
	    i__2 = *n - k;
	    zscal_(&i__2, &work[1], &b[k + (k + 1) * b_dim1], ldb);
	    i__2 = *n - k + 1;
	    zscal_(&i__2, &work[1], &a[k + k * a_dim1], lda);
	    if (*wantq) {
		zscal_(n, &work[2], &q[k * q_dim1 + 1], &c__1);
	    }
	} else {
	    i__2 = k + k * b_dim1;
