/* ../../../dependencies/lapack/src/cgglse.f -- translated by f2c (version 20061008).
...
/*     Solve T12*x2 = d for x2 */
    ...
    ctrsv_("Upper", "No transpose", "Non unit", p, &b[(*n - *p + 1) * b_dim1 
...
/*     Compute the residual vector: */
	...
	i__1 = *n - *m;
	q__1.r = -1.f, q__1.i = -0.f;
	cgemv_("No transpose", &nr, &i__1, &q__1, &a[*n - *p + 1 + (*m + 1) * 
