/* ../../../dependencies/lapack/src/zgesdd.f -- translated by f2c (version 20061008).
...
/*              Set the right corner of U to identity matrix */
		...
		i__2 = *m - *n;
		i__1 = *m - *n;
		zlaset_("F", &i__2, &i__1, &c_b1, &c_b2, &u[*n + 1 + (*n + 1) 
			* u_dim1], ldu, (ftnlen)1);
...
/*              Set the right corner of VT to identity matrix */
		...
		i__1 = *n - *m;
		i__2 = *n - *m;
		zlaset_("F", &i__1, &i__2, &c_b1, &c_b2, &vt[*m + 1 + (*m + 1)
...
/*              (RWorkspace: M*M) */
		...
		zlaset_("F", n, n, &c_b1, &c_b1, &vt[vt_offset], ldvt, (
			ftnlen)1);
		zlacp2_("F", m, m, &rwork[irvt], m, &vt[vt_offset], ldvt, (
			ftnlen)1);
		i__1 = *lwork - nwork + 1;
