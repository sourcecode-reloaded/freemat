/* ../../../dependencies/lapack/src/clarrv.f -- translated by f2c (version 20061008).
...
/* Computing MIN */
			    ...
			    csscal_(&in, &nrminv, &z__[ibegin + ktot * z_dim1]
				    , &c__1);
			    ++ktot;
/* L100: */
			}
			if (newsiz > 1) {
				...
				for (q = newftt; q <= i__5; ++q) {
				    cdotu_(&q__2, &in, &z__[ibegin + p * 
					    z_dim1], &c__1, &z__[ibegin + q * 
					    z_dim1], &c__1);
				    q__1.r = -q__2.r, q__1.i = -q__2.i;
				    tmp1 = q__1.r;
				    q__1.r = tmp1, q__1.i = 0.f;
				    caxpy_(&in, &q__1, &z__[ibegin + q * 
					    z_dim1], &c__1, &z__[ibegin + p * 
					    z_dim1], &c__1);
/* L110: */
				}
				tmp1 = 1.f / scnrm2_(&in, &z__[ibegin + p * 
					z_dim1], &c__1);
				csscal_(&in, &tmp1, &z__[ibegin + p * z_dim1],
					 &c__1);
/* Computing MIN */
