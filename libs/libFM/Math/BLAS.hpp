...
namespace FM
{
  ...
  inline void BLAS_gemm(int Arows, int Acols, int Ccols, const double *A, const double *B, double *C) {
    return BLAS_dgemm(Arows,Acols,Ccols,A,B,C);
  }
  
  inline void BLAS_gemm(int Arows, int Acols, int Ccols, const float *A, const float *B, float *C) {
    return BLAS_sgemm(Arows,Acols,Ccols,A,B,C);
  }
  
  inline void BLAS_gemm(int Arows, int Acols, int Ccols, const Complex<double> *A, const Complex<double> *B, Complex<double> *C) {
    return BLAS_zgemm(Arows,Acols,Ccols,A,B,C);
  }
  
  inline void BLAS_gemm(int Arows, int Acols, int Ccols, const Complex<float> *A, const Complex<float> *B, Complex<float> *C) {
