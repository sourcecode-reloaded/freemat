...
C   subprogram,  DCALJY0.  The calling statements for the primary
C   entries are:
C
C           Y = BESJ0(X)
C   and
...
C   respectively.  The routine  DCALJY0  is intended for internal packet
C   us-e only, all computations within the packet being concentrated in
C   this one routine.  The function subprograms invoke  DCALJY0  with
C   the statement
C           CALL DCALJY0(ARG,RESULT,JINT),
C   where the parameter usage is as follows:
C
C      Function                  Parameters for DCALJY0
...
C
C    C 7600      (S.P.)  7.11E-15  1.34E+08  2.98E-08  1.26E+322
...
C   (see comments heading DCALJY0).
C
C--------------------------------------------------------------------
      INTEGER JINT
