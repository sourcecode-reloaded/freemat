      SUBROUTINE DCALCI0(ARG,RESULT,JINT)
C--------------------------------------------------------------------
C
...
C   and BESEI0, and one subroutine type subprogram, DCALCI0.
...
C   EXP(-ABS(X))*I0(X), respectively.  The routine DCALCI0 is
...
C   subprograms invoke DCALCI0 with the statement
C          CALL DCALCI0(ARG,RESULT,JINT)
C   where the parameter usage is as follows
C
C      Function                     Parameters for DCALCI0
...
C   arguments ABS(ARG) .LE. XMAX  (see comments heading DCALCI0).
C
C--------------------------------------------------------------------
      INTEGER JINT
      DOUBLE PRECISION  
...
C--------------------------------------------------------------------
      JINT=1
      CALL DCALCI0(X,RESULT,JINT)
      DBESI0=RESULT
      RETURN
C---------- Last line of BESI0 ----------
      END
      DOUBLE PRECISION 
     1    FUNCTION DBESEI0(X)
C--------------------------------------------------------------------
C
