...
C
C   The routine  CALERF  is intended for internal packet us-e only,
...
C------------------------------------------------------------------
      DATA FOUR,ONE,HALF,TWO,ZERO/4.0E0,1.0E0,0.5E0,2.0E0,0.0E0/,
     1     SQRPI/5.6418958354775628695E-1/,THRESH/0.46875E0/,
     2     SIXTEN/16.0E0/
C------------------------------------------------------------------
C  Machine-dependent constants
C------------------------------------------------------------------
      DATA XINF,XNEG,XSMALL/3.40E+38,-9.382E0,5.96E-8/,
     1     XBIG,XHUGE,XMAX/9.194E0,2.90E3,4.79E37/
C------------------------------------------------------------------
C  Coefficients for approximation to  erf  in first interval
C------------------------------------------------------------------
      DATA A/3.16112374387056560E00,1.13864154151050156E02,
     1       3.77485237685302021E02,3.20937758913846947E03,
     2       1.85777706184603153E-1/
      DATA B/2.36012909523441209E01,2.44024637934444173E02,
     1       1.28261652607737228E03,2.84423683343917062E03/
C------------------------------------------------------------------
C  Coefficients for approximation to  erfc  in second interval
C------------------------------------------------------------------
      DATA C/5.64188496988670089E-1,8.88314979438837594E0,
     1       6.61191906371416295E01,2.98635138197400131E02,
     2       8.81952221241769090E02,1.71204761263407058E03,
     3       2.05107837782607147E03,1.23033935479799725E03,
     4       2.15311535474403846E-8/
      DATA D/1.57449261107098347E01,1.17693950891312499E02,
     1       5.37181101862009858E02,1.62138957456669019E03,
     2       3.29079923573345963E03,4.36261909014324716E03,
     3       3.43936767414372164E03,1.23033935480374942E03/
C------------------------------------------------------------------
C  Coefficients for approximation to  erfc  in third interval
C------------------------------------------------------------------
      DATA P/3.05326634961232344E-1,3.60344899949804439E-1,
     1       1.25781726111229246E-1,1.60837851487422766E-2,
     2       6.58749161529837803E-4,1.63153871373020978E-2/
      DATA Q/2.56852019228982242E00,1.87295284992346047E00,
     1       5.27905102951428412E-1,6.05183413124413191E-2,
     2       2.33520497626869185E-3/
C------------------------------------------------------------------
      X = ARG
      Y = ABS(X)
      IF (Y .LE. THRESH) THEN
