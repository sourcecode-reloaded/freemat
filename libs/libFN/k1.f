...
C   for internal packet us-e only, all computations within the
...
C--------------------------------------------------------------------
      DATA XLEAST/1.18E-38/,XSMALL/5.95E-8/,XINF/3.40E+38/,
     1     XMAX/85.343E+0/
C--------------------------------------------------------------------
C  Coefficients for  XLEAST .LE.  ARG  .LE. 1.0
C--------------------------------------------------------------------
      DATA   P/ 4.8127070456878442310E-1, 9.9991373567429309922E+1,
     1          7.1885382604084798576E+3, 1.7733324035147015630E+5,
     2          7.1938920065420586101E+5/
      DATA   Q/-2.8143915754538725829E+2, 3.7264298672067697862E+4,
     1         -2.2149374878243304548E+6/
      DATA   F/-2.2795590826955002390E-1,-5.3103913335180275253E+1,
     1         -4.5051623763436087023E+3,-1.4758069205414222471E+5,
     2         -1.3531161492785421328E+6/
      DATA   G/-3.0507151578787595807E+2, 4.3117653211351080007E+4,
     2         -2.7062322985570842656E+6/
C--------------------------------------------------------------------
C  Coefficients for  1.0 .LT.  ARG
C--------------------------------------------------------------------
      DATA  PP/ 6.4257745859173138767E-2, 7.5584584631176030810E+0,
     1          1.3182609918569941308E+2, 8.1094256146537402173E+2,
     2          2.3123742209168871550E+3, 3.4540675585544584407E+3,
     3          2.8590657697910288226E+3, 1.3319486433183221990E+3,
     4          3.4122953486801312910E+2, 4.4137176114230414036E+1,
     5          2.2196792496874548962E+0/
      DATA  QQ/ 3.6001069306861518855E+1, 3.3031020088765390854E+2,
     1          1.2082692316002348638E+3, 2.1181000487171943810E+3,
     2          1.9448440788918006154E+3, 9.6929165726802648634E+2,
     3          2.5951223655579051357E+2, 3.4552228452758912848E+1,
     4          1.7710478032601086579E+0/
C--------------------------------------------------------------------
      X = ARG
      IF (X .LT. XLEAST) THEN
C--------------------------------------------------------------------
