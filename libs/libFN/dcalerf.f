      SUBROUTINE DCALERF(ARG,RESULT,JINT)
C------------------------------------------------------------------
C
...
C   and one SUBROUTINE type subprogram, DCALERF.  The calling
...
C
C   The routine  DCALERF  is intended for internal packet us-e only,
...
C   statement
C
C          CALL DCALERF(ARG,RESULT,JINT)
C
C   where the parameter usage is as follows
C
C      Function                     Parameters for DCALERF
