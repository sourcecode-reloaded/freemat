      SUBROUTINE DCALCI1(ARG,RESULT,JINT)
C--------------------------------------------------------------------
C
...
C   and BESEI1, and one subroutine type subprogram, DCALCI1.
...
C
C      Function                     Parameters for DCALCI1
...
C   arguments ABS(ARG) .LE. XMAX  (see comments heading DCALCI1).
C
C--------------------------------------------------------------------
      INTEGER JINT
      DOUBLE PRECISION
...
C--------------------------------------------------------------------
      JINT=1
      CALL DCALCI1(X,RESULT,JINT)
      DBESI1=RESULT
      RETURN
C---------- Last line of BESI1 ----------
      END
      DOUBLE PRECISION
     1    FUNCTION DBESEI1(X)
C--------------------------------------------------------------------
C
