...
ArrayVector AcoshFunction(int, const ArrayVector&);
ArrayVector AsinhFunction(int, const ArrayVector&);
...
void LoadBuiltinFunctions(Context *context, bool guiflag) {
  ...
  context->addFunction("acosh",AcoshFunction,1,1,"x",NULL);
  context->addFunction("asinh",AsinhFunction,1,1,"x",NULL);
