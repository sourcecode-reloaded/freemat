...
*     .. Local Arrays ..
     ...
     $                   TIMTBL( 6*6*MAXSZS*MAXPRM*5 )
      COMPLEX*16         A( LA, 3 ), B( LA, 3 ), E( 2*NMAX ),
...
*     .. External Subroutines ..
     ...
     $                   ZTIMHE, ZTIMHP, ZTIMHR, ZTIMLQ, ZTIMLS, ZTIMMM,
     $                   ZTIMMV, ZTIMPB, ZTIMPO, ZTIMPP, ZTIMPT, ZTIMQ3,
     $                   ZTIMQL, ZTIMQP, ZTIMQR, ZTIMRQ, ZTIMSP, ZTIMSY,
     $                   ZTIMTB, ZTIMTD, ZTIMTP, ZTIMTR
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
         CALL ZTIMQ3( LINE, NM, MVAL, NVAL, NNB, NBVAL, NXVAL, NLDA,
...
*
         CALL ZTIMLS( LINE, NM, MVAL, NN, NVAL, NK, KVAL, NNB, NBVAL,
