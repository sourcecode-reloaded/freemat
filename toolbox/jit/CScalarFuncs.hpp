...
// Here, each function gets prototyped.
  ...
  double _jit_rem(double a0,double a1);
...
static const char* jit_scalar_list[] = {"erfc","erf","erfinv","gamma","gammaln","ceil","round","min","bitand","bitor","bitxor","pi","e","floor","fix","rem","tanh","cosh","sinh","exp","expm1","abs","cos","cosd","sin","sind","tan","tand","csc","cscd","sec","secd","cot","cotd","atan","atan2","infp","nan","NaN","max","isnan","isinf",""};
